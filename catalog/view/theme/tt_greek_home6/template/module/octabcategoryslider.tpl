						...
						<li class="item">
							...
							<div class="product-image">
								<?php if ($product['thumb']) { ?>
									...
									<div class="image1"><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
									<?php } else { ?>
								...
								<div class="actions">
									...
									<div class="add-to-links">
											<div class="wishlist"><button data-toggle="tooltip" class="fa fa-heart" type="button" title="<?php echo $button_wishlist; ?>"  onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_wishlist; ?></span></button></div>
											<div class="compare"><button data-toggle="tooltip" class="fa fa-retweet" type="button" title="<?php echo $button_compare; ?>"  onclick="compare.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_compare; ?></span></button></div>
									</div>
