	<style>
	 .f-section{overflow: hidden;clear: both;}
     .btn{float: right;display: flex;width: 150px;overflow: hidden;
     	  transition:right 2s linear,ease 1s;}
     .pay-btn input[type="button"] {padding: 0px 15px;margin: 5px 0 8px;border: 0;background: #FFC107;border-radius:10px;outline: -webkit-focus-ring-color auto 0px;;}
     .slide-btn{padding: 5px;-webkit-filter: grayscale(1) !important;}
     .slide-btn:hover{-webkit-filter: grayscale(0) !important;-ms-filter: grayscale(0) !important;-moz-filter: grayscale(0) !important;}
     .yahooo{width: 675px;transition:right 2s linear,ease 8s;}
     .yahooo input[type="button"] {background: #FF5722;}
	</style> 
	...
	<div class="row">
		<div class="f-col f-col-1 col-sm-4 col-md-4 col-xs-12">
			<ul class="link-follow">
				...
				<li class="last"><a class="google fa fa-google-plus" href="#"><span>google </span></a></li>
			</ul>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="column col col-xs-6 col-sm-6 col-md-4">
				<p class="logo"><a href="#"><img src="catalog/view/theme/tt_greek_home1/image/logo.png" alt=""></a></p>
...
<div class="powered">
	<div class="container">
        ...
        <div class="pay-btn btn">
            <input id="button" class="" type="button"value="PAYMENT DETAIL">
            <div class="slide-btn">
                <a href="https://www.google.com.pk"target="_blank"alt="google">
                    <img src="img/std.jpg">
                </a>
            </div>
             <div class="slide-btn">
                <a href="#">
                    <img src="img/bank-alfalah.jpg">
                </a>
            </div>
             <div class="slide-btn">
                <a href="#">
