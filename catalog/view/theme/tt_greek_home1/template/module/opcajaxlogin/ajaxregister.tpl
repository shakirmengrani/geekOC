        ...
        <form action="<?php echo $action; ?>" method="post" id="ajax-register-form" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="buttons">
                <div class="pull-right"><?php echo $text_agree; ?>
                    ...
                    <?php } ?>
                    &nbsp;
                    <input type="button" onclick="opcajaxlogin.registerAction();" value="<?php echo $button_continue; ?>" class="btn btn-primary" />
            ...
            <div class="buttons">
                <div class="pull-right">
                    <button type="button" onclick="opcajaxlogin.registerAction();"  class="button"><span><?php echo $button_continue; ?></span></button>
                    <img class="ajax-load-img" alt="" src="<?php echo $loader_img ?>" width="30" height="30" />
                </div>
            </div>
            <?php } ?>
