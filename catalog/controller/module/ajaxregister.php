...
class ControllerModuleAjaxregister extends Controller {

    private $error = array();

    public function index() {
        $this->load->language('module/ajaxregister'); // loads the language file of Ajax Login

        $data['heading_title'] = $this->language->get('heading_title'); // set the heading_title of the module

        // Add Css and Js Datetime picker
        ...
        $data['action'] = $this->url->link('module/ajaxregister', '', 'SSL');

        // Check request and fill field
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/opcajaxlogin/ajaxregister.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/module/opcajaxlogin/ajaxregister.tpl', $data);
        } else {
            return $this->load->view('default/template/module/opcajaxlogin/ajaxregister.tpl', $data);
        }
    }
    ...
    public function register() {
        ...
        $this->load->model('account/customer');
        $this->load->model('module/ajaxregister');
        $this->load->language('module/ajaxregister');

        $json = array();

        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_module_ajaxregister->addCustomer($this->request->post);
...
//        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/opcajaxlogin/success.tpl')) {
//            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/module/opcajaxlogin/success.tpl', $data));
//        } else {
//            $this->response->setOutput($this->load->view('default/template/module/opcajaxlogin/success.tpl', $data));
//        }
    }
