						 ...
						 <?php foreach ($languages as $language) { ?>
						 	<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
							   ...
							   <div class="form-group  entry_des">
								...
								<textarea name="cmsblock_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($cmsblock_description[$language['language_id']]) ? $cmsblock_description[$language['language_id']]['description'] : ''; ?></textarea>
