    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-octabcategoryslider" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-cate_id"><?php echo $entry_category; ?></label>
            <div class="col-sm-10">
              <input type="text" name="cate_id" value="<?php echo $cate_id; ?>" placeholder="<?php echo $entry_category; ?>" id="input-cate_id" class="form-control" />
            </div>
          </div>
		  <div class="form-group">
