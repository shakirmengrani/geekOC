        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-width"><?php echo $text_ttcountdown_width; ?></label>
                        <div class="col-sm-10">
                            <input type="text" id="input-width" name="width" value="<?php echo isset($width)? $width:'' ; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-height"><?php echo $text_ttcountdown_height; ?></label>
                        <div class="col-sm-10">
