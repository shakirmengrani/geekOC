				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					     <select name="ocslideshow_image[<?php echo $image_row; ?>][type]" id="input-type" class="form-control">
							<option value="1" <?php if($ocslideshow_image['type'] == '1'): ?>selected="selected"<?php endif; ?>>Type 1</option>
							<option value="2" <?php if($ocslideshow_image['type'] == '2'): ?>selected="selected"<?php endif; ?>>Type 2</option>
							<option value="3" <?php if($ocslideshow_image['type'] == '3'): ?>selected="selected"<?php endif; ?>>Type 3</option>
						  </select>
					</div>
				  </div>
					<?php 
